...
from . import views
from .views import (
    MailingDetailView, MailingListView, MailingCreateView,
    MailingUpdateView, MailingDeleteView,
    recipients_stats_view, MailingRecipientListView,
    MailingRecipientDetailView, MailingRecipientCreateView,
